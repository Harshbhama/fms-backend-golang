...
func (h *FreelancerHandler) GetFreelancerForClient(c *gin.Context) {
	...
	freelancers, err := h.Service.GetFreelancerByClientID(uint(id), search)
	h.logger.Info("Freelancers fetched for client ID:", id, freelancers)
	if err != nil {
		h.logger.Error("Failed to get freelancers for client:", err)
...
func (h *FreelancerHandler) GetProjectsForFreelancer(c *gin.Context) {
	...
	h.logger.Info("Projects fetched for freelancer ID:", id)
	if err != nil {
...
func (h *FreelancerHandler) GetClientsForFreelancer(c *gin.Context) {
	...
	h.logger.Info("Clients fetched for freelancer ID:", id)
	if err != nil {
